                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <?php endif; ?>
                                <a href="../index.php" class="btn btn-secondary mb">
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>
                                                    <a href='anggota.php?edit=" . $row['id'] . "' class='btn btn-warning btn-sm'><i class='bi bi-pencil-square'></i> Edit</a>
                                                    <a href='anggota.php?hapus=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Yakin ingin menghapus data ini?');\"><i class='bi bi-trash'></i> Hapus</a>
                                                  </td>";
                                            echo "</tr>";
                                        }
                                    } else {
