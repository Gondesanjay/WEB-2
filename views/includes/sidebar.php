            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="../views/anggota/anggota.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
                            Data Anggota
                        </a>
                        <a class="nav-link" href="../views/pegawai/list-pegawai.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-user-tie"></i></div>
                            Data Pegawai
                        </a>
                        <a class="nav-link" href="../views/kartu diskon/kartu_diskon.php">
                ...
                <div class="collapse" id="manajemenProduk" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="../views/produk/data_produk.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-box"></i></div>
                            Data Produk
                        </a>
                        <a class="nav-link" href="../views/jenis produk/jenis_produk.php">
                ...
                <!-- Pemesanan -->
                <a class="nav-link" href="../views/pemesanan/pemesanan.php">
                    <div class="sb-nav-link-icon"><i class="fas fa-shopping-cart"></i></div>
                    Pemesanan
                </a>
                
                <!-- Transaksi -->
                <a class="nav-link" href="../views/transaksi/pembayaran.php">
